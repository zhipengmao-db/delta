...
class DeltaTableBuilder(object):
    ...
    def _check_identity_column_spec(self, dataType: Union[str, DataType],
                                    identityGenerator: IdentityGenerator) -> None:
    ...
    def addColumn(
        ...
        if generatedAlwaysAs is not None:
            if type(generatedAlwaysAs) is str:
                ...
                self._check_identity_column_spec(dataType, generatedAlwaysAs)
            ...
            self._check_identity_column_spec(dataType, generatedByDefaultAs)
